...
B10: new sheetCalc.Cell(function(){return sheetCalc.WorkBook.Student.B9.value();}),
L7: new sheetCalc.Cell("Curiosity"),
I10: new sheetCalc.Cell(function(){return formulajs.MOD(sheetCalc.WorkBook.Student.H9.value()*sheetCalc.WorkBook.Student.I9.value()+sheetCalc.WorkBook.Student.H10.value(),5)+1;}),
M10: new sheetCalc.Cell(function(){return formulajs.MOD(sheetCalc.WorkBook.Student.L9.value()*sheetCalc.WorkBook.Student.M9.value()+sheetCalc.WorkBook.Student.L10.value(),5)+1;}),
E8: new sheetCalc.Cell("OWS.Models.Game.Actor.IParent"),
C9: new sheetCalc.Cell(3),
E10: new sheetCalc.Cell(function(){return sheetCalc.WorkBook.Student.E9.value();}),
B9: new sheetCalc.Cell(1),
K10: new sheetCalc.Cell(function(){return formulajs.MOD(sheetCalc.WorkBook.Student.J9.value()*sheetCalc.WorkBook.Student.K9.value()+sheetCalc.WorkBook.Student.J10.value(),5)+1;}),
P9: new sheetCalc.Cell(4),
D9: new sheetCalc.Cell("-"),
P10: new sheetCalc.Cell(function(){return formulajs.MOD(sheetCalc.WorkBook.Student.O9.value()*sheetCalc.WorkBook.Student.P9.value()+sheetCalc.WorkBook.Student.O10.value(),5)+1;}),
...
N10: new sheetCalc.Cell(function(){return formulajs.MOD(sheetCalc.WorkBook.Student.M9.value()*sheetCalc.WorkBook.Student.N9.value()+sheetCalc.WorkBook.Student.M10.value(),5)+1;}),
O10: new sheetCalc.Cell(function(){return formulajs.MOD(sheetCalc.WorkBook.Student.N9.value()*sheetCalc.WorkBook.Student.O9.value()+sheetCalc.WorkBook.Student.N10.value(),5)+1;}),
A10: new sheetCalc.Cell("Outputs"),
M7: new sheetCalc.Cell("Collaboration"),
C10: new sheetCalc.Cell(function(){return sheetCalc.WorkBook.Student.C9.value();}),
D10: new sheetCalc.Cell(function(){return sheetCalc.WorkBook.Student.D9.value();}),
A9: new sheetCalc.Cell("Inputs"),
F10: new sheetCalc.Cell(function(){return sheetCalc.WorkBook.Student.F9.value();}),
G10: new sheetCalc.Cell(function(){return sheetCalc.WorkBook.Student.G9.value();}),
H9: new sheetCalc.Cell(2),
J10: new sheetCalc.Cell(function(){return formulajs.MOD(sheetCalc.WorkBook.Student.I9.value()*sheetCalc.WorkBook.Student.J9.value()+sheetCalc.WorkBook.Student.I10.value(),5)+1;}),
H10: new sheetCalc.Cell(function(){return formulajs.MOD(formulajs.ROUND(formulajs.RAND()*1000, 0),5)+1;}),
L10: new sheetCalc.Cell(function(){return formulajs.MOD(sheetCalc.WorkBook.Student.K9.value()*sheetCalc.WorkBook.Student.L9.value()+sheetCalc.WorkBook.Student.K10.value(),5)+1;}),
...
LoadModel: function(model) {sheetCalc.WorkBook.Student.B9.value(model.ID);
